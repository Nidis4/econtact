...
updateProfessional($name, $surname, $email, $mob, $tel, $address, $address1, $address2, $spec, $avail, $notes);
updateProfLocation($email,$address1,$address2);
//updateProfCategory($email,$cat);
?>